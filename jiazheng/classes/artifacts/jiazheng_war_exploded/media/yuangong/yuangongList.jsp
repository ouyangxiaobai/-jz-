...
<title></title>
 ...
 <script type="text/javascript" src="<%=basePath%>media/yuangong/js/ian.js"></script>
  <script type="text/javascript" src="<%=basePath%>media/yuangong/js/page.js"></script>
  <script type="text/javascript" src="<%=basePath%>media/yuangong/js/pageMedia.js"> </script>
<script type="text/javascript" src="<%=basePath%>media/yuangong/js/commcom.js"></script>
 
<script type="text/javascript" src="<%=basePath%>media/yuangong/js/yuangongList.js"></script>
...
<div class="tab-content contents"> 
	<h3 class="form-section">&nbsp;&nbsp;&nbsp;<font style="font-weight:bold" >送餐员管理</font></h3>
	<div class="row-fluid">
			
		 <form class="layui-form xbs" action="">
                <div class="layui-form-pane" style="text-align: center;">
                  <div class="layui-form-item" style="display: inline-block;">
                    <label class="layui-form-label xbs768">送餐员名</label> 
                    <div class="layui-input-inline xbs768">
                      <input class="layui-input"  id="a1" placeholder="请输入送餐员名" id="LAY_demorange_e">
                    </div> 
