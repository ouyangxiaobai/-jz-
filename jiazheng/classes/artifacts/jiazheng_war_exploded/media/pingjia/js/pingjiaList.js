...
$(function(){
    ...
    getData();
   	...
   	$("#addbutton").on("click",function(){
   		...
   		window.location.href=getIP()+"media/pingjia/pingjiaAdd.jsp";
   	})
    ...
    $("#delbutton").on("click",function(){
    	...
    	if(confirm("确定要删除吗？")){
        	...
        	del.ajax(getIP()+"pingjia.action?delMore",function(data){
        		if(data.success){
    ...
    function getData(){  
	   	...
	   	getPageData(sel,getIP()+"pingjia.action?list",function(data){
...
function update(id){
	 ...
	 window.location.href=getIP()+"media/pingjia/pingjiaModify.jsp?eid="+id;
}
//修改
function jieshu(id){
