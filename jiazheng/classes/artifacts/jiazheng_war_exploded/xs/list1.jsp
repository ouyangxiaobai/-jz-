    ...
    <div id="a8">
        <div id="a8_1" style="background-color:white;">
              ...
              <div class="left_box1111">
                ...
                <ul>
                    <li onmouseout="aaa('img1','<%=basePath%>xs/images/v_05.png')" onmouseover="bbb('img1','<%=basePath%>xs/images/x_05.png')">
                        <!-- <img  id="img1" src="images/v_05.png" />-->
                    </li>
                    <li onmouseout="ocdd('img2','<%=basePath%>xs//images/v_08.png')" onmouseover="cltd('img2','<%=basePath%>xs/images/x_08.png')">
                        <img id="img2" src="<%=basePath%>xs/images/v_08.png" /></li>
                    <li onmouseout="ocdd('img3','<%=basePath%>xs/images/v_12.png')" onmouseover="cltd('img3','<%=basePath%>xs/images/x_12.png')">
                        <img id="img3" src="<%=basePath%>xs/images/v_12.png" /></li>
                    <li onmouseout="ocdd('img4','<%=basePath%>xs/images/v_14.png')" onmouseover="cltd('img4','<%=basePath%>xs/images/x_14.png')">
                        <img id="img4" src="<%=basePath%>xs/images/v_14.png" /></li>
                    <li onmouseout="ocdd('img5','<%=basePath%>xs/images/v_16.png')" onmouseover="cltd('img5','<%=basePath%>xs/images/x_16.png')">
                        <img id="img5" src="<%=basePath%>xs/images/v_16.png" /></li>
                    <li onmouseout="ocdd('img6','<%=basePath%>xs/images/v_18.png')" onmouseover="cltd('img6','<%=basePath%>xs/images/x_18.png')">
                        <img id="img6" src="<%=basePath%>xs/images/v_18.png" /></li>
                    <li onmouseout="ocdd('img7','<%=basePath%>xs/images/v_20.png')" onmouseover="cltd('img7','<%=basePath%>xs/images/x_20.png')">
                        <img id="img7" src="<%=basePath%>xs/images/v_20.png" /></li>
                    <li onmouseout="ocdd('img8','<%=basePath%>xs/images/v_22.png')" onmouseover="cltd('img8','<%=basePath%>xs/images/x_22.png')">
                        <img id="img8" src="<%=basePath%>xs/images/v_22.png" /></li>
                </ul>
            </div>
        </div>
        ...
        <div id="a8_2" style="padding:0px; background-color:#FAFAFA;height:582px;">
			...
			作者：${article.editor}&nbsp;&nbsp;来源：临床医学院&nbsp;&nbsp;发布时间：${fn:substring(article.adddate,0,19)}&nbsp;&nbsp;浏览次数：${article.hits}</td></tr>
			<tr>
