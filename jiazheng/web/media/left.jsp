...
<head>
  ...
  <script src="<%=basePath%>media/js/jquery-1.9.1.min.js"></script>
...
<table style="width:100%;">
  ...
  <td style="width:2em" valign="top" style="background-color:black">
    ...
    <div id="open">
        <div class="navH">
          图片素材网站
            <span><img class="obscure" src="<%=basePath%>media/images/obscure.png" alt=""></span>
        </div>
        <div class="navBox">
			<ul id="leftmenuclick"> 
    ...
    <td valign="top" >
   <iframe id="aaabb" runat="server" src="<%=basePath%>media/welcome.jsp" width="100%" height="600px" frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes"></iframe>
   	<td>
	</tr>
