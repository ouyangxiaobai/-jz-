...
<title></title>
 ...
 <script type="text/javascript" src="<%=basePath%>media/dingdan/js/ian.js"></script>
  <script type="text/javascript" src="<%=basePath%>media/dingdan/js/page.js"></script>
  <script type="text/javascript" src="<%=basePath%>media/dingdan/js/pageMedia.js"> </script>
<script type="text/javascript" src="<%=basePath%>media/dingdan/js/commcom.js"></script>
 
<script type="text/javascript" src="<%=basePath%>media/dingdan/js/dingdanList.js"></script>
...
<div class="tab-content contents"> 
	<h3 class="form-section">&nbsp;&nbsp;&nbsp;<font style="font-weight:bold" >订单管理</font></h3>
	<div class="row-fluid">
		   ...
		   <xblock style="padding-left:20px;">&nbsp;<button class="layui-btn" id="delbutton"><i class="layui-icon">&#xe608;</i>删除</button></xblock>
	           ...
	           <thead>
	               <tr>
	                   <th style="width:5%;"><input type="checkbox"  id="queryCheckbox"  name="queryCheckbox" value=""></th>
	                    ...
	                    <th style="width:6%;">人员名</th>
	                     <th style="width:6%;">价格</th>
	                    <th style="width:6%;">支付人</th>
	                   <th style="width:6%;">联系方式</th>
	                     <th style="width:6%;">支付时间</th>
