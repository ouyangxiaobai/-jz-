...
public interface vrenyuanMapper extends BaseDao<vrenyuan, String> {
	/*
    ...
    List<fangjian> selectByExampleWithBLOBs(fangjianExample example);
    ...
    int updateByExampleWithBLOBs(@Param("record") fangjian record, @Param("example") fangjianExample example);
